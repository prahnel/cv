...
ActiveRecord::Schema[7.1].define(version: 2025_03_21_202617) do
  create_table "basic_informations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "email"
    t.string "phone"
    ...
    t.index ["cv_id"], name: "index_basic_informations_on_cv_id"
  end
  ...
  add_foreign_key "basic_informations", "cvs"
